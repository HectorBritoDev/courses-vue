    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-8 offset-2 listing-block">
                <div class="media">
                    <img class="rounded" src="{{ $review->user->pathAttachment() }}" alt="{{ $review->user->name }}">
            ...
            @empty
            <div class="alert alert-dark"><i class="fa fa-into-circle"></i>{{ __('Sin valoraciones todavía') }} </div>
            @endforelse
        </div>
    </div>
</div>
